...
$ts_shortcodes['blog'] = array(
	...
	'params' => array(
		...
		'layout' => array(
			...
			'options' => array(
				...
				'banner' => __('Banner', 'ThemeStockyard')
			)
		),
		...
		'allow_videos' => array(
			...
			'desc' => __('If set to &#8220;No&#8221, only featured images will be shown. (Videos are not compatible with "2 Column Grid" and "3 Column Grid" layouts)', 'ThemeStockyard'),
			'options' => $choices,
			'std' => 'yes'
		),
	...
	'shortcode' => '[blog layout="{{layout}}" limit="{{posts_per_page}}" infinite_scroll="{{infinite_scroll}}" infinite_scroll_button_text="{{infinite_scroll_button_text}}" category_name="{{category_name}}" include="{{include}}" exclude="{{exclude}}" exclude_previous_posts="{{exclude_previous_posts}}" exclude_these_later="{{exclude_these_later}}" excerpt_length="{{excerpt_length}}" title_size="{{title_size}}" text_align="{{text_align}}" show_pagination="{{show_pagination}}" show_excerpt="{{show_excerpt}}" show_meta="{{show_meta}}" show_read_more="{{show_read_more}}" allow_videos="{{allow_videos}}" allow_galleries="{{allow_galleries}}" ignore_sticky_posts="{{ignore_sticky_posts}}"][/blog]',
...
$ts_shortcodes['blog_banner'] = array(
	...
	'params' => array(
		...
		'text_position' => array(
			'type' => 'select',
			'label' => __( 'Text Position', 'ThemeStockyard'),
			'options' => array(
                '' => __('Alternating (left, right, left, ...)', 'ThemeStockyard'),
                'left' => __('Left','ThemeStockyard'),
                //'center' => __('Center','ThemeStockyard'),
                'right' => __('Right','ThemeStockyard')
			),
	...
	'shortcode' => '[blog_banner limit="{{posts_per_page}}" infinite_scroll="{{infinite_scroll}}" infinite_scroll_button_text="{{infinite_scroll_button_text}}" category_name="{{category_name}}" include="{{include}}" exclude="{{exclude}}" exclude_previous_posts="{{exclude_previous_posts}}" exclude_these_later="{{exclude_these_later}}" excerpt_length="{{excerpt_length}}" show_pagination="{{show_pagination}}" text_position="{{text_position}}" ignore_sticky_posts="{{ignore_sticky_posts}}"][/blog_banner]',
...
$ts_shortcodes['blog_slider'] = array(
	...
	'shortcode' => '[blog_slider limit="{{limit}}" category_name="{{category_name}}" include="{{include}}" exclude="{{exclude}}" exclude_previous_posts="{{exclude_previous_posts}}" exclude_these_later="{{exclude_these_later}}" title_size="{{title_size}}" text_align="{{text_align}}" allow_videos="{{allow_videos}}" image_size="{{image_size}}" ignore_sticky_posts="{{ignore_sticky_posts}}"][/blog_slider]',
...
$ts_shortcodes['blog_widget'] = array(
	...
	'shortcode' => '[blog_widget widget_heading="{{widget_heading}}" widget_layout="{{widget_layout}}" limit="{{limit}}" category_name="{{category_name}}" override_widget_heading="{{override_widget_heading}}" include="{{include}}" exclude="{{exclude}}" exclude_previous_posts="{{exclude_previous_posts}}" exclude_these_later="{{exclude_these_later}}" excerpt_length="{{excerpt_length}}" title_size="{{title_size}}" text_align="{{text_align}}" show_excerpt="{{show_excerpt}}" show_meta="{{show_meta}}" show_media="{{show_media}}" allow_videos="{{allow_videos}}" allow_galleries="{{allow_galleries}}" ignore_sticky_posts="{{ignore_sticky_posts}}"][/blog_widget]',
