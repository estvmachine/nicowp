...
class tsShortcodes {
    ...
    function __construct()
    {
		...
		define('TS_TINYMCE_URI', TS_ESSENTIALS_URI.'includes/shortcodes/tinymce');
		define('TS_TINYMCE_DIR', TS_ESSENTIALS_DIR.'includes/shortcodes/tinymce');
	...
	function admin_init()
	{
		...
		wp_localize_script( 'jquery', 'tsShortcodes', array('theurl' => TS_TINYMCE_URI, 'wp_version' => $ts_wp_version) );
	}
	...
	function popup() {
		...
		ts_essentials_load_file( 'includes/shortcodes/tinymce/ts-sc' );
