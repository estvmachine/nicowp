...
class TT_Example_List_Table extends WP_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => 'pregunta',     //singular name of the listed records
            'plural'    => 'preguntas',    //plural name of the listed records
    ...
    function column_title($item){
        ...
        //Build row actions
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&action=%s&pregunta=%s">Edit</a>',$_REQUEST['page'],'edit',$item['id_pregunta']),
            'delete'    => sprintf('<a href="?page=%s&action=%s&pregunta=%s">Delete</a>',$_REQUEST['page'],'delete',$item['id_pregunta']),
        );

        //Return the title contents
        return sprintf('%1$s <span style="color:silver">(id:%2$s)</span>%3$s',
            /*$1%s*/ $item['contenido_pregunta'],
            /*$2%s*/ $item['id_pregunta'],
    ...
    function column_cb($item){
        return sprintf(
            ...
            /*$2%s*/ $item['id_pregunta']                //The value of the checkbox should be the record's id
        );
    }
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            'contenido_pregunta'     => array('title',false),     //true means it's already sorted
