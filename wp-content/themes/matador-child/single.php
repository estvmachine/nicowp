                ...
                <div id="main-container" class="container clearfix">
                    <div id="main" class="<?php echo esc_attr(ts_main_div_class());?> clearfix">
                        <div class="entry single-entry clearfix">
                            <?php
                            if(has_term('elchat', 'category', $post)){
                              //No hago nada
                            }else {
                                    ...
                                    <div id="ts-post" <?php post_class('post ts-post-section clearfix'); ?>>
                                        ...
                                        <div id="ts-post-the-content-wrap">
                                            ...
                                            <div id="ts-post-comments-share-wrap" class="clearfix">
                                                ...
                                                ?>
                                                <a href="<?php echo get_permalink().ts_link2comments();?>" class="to-comments-link small-size smoothscroll" id="ts-moon-comment-bubble"><strong class="disqus-comment-count" data-disqus-url="<?php echo get_permalink();?>"><?php
                                                    echo sprintf( _n( '%s comment', '%s comments', $comment_number, 'ThemeStockyard' ), $comment_number );?></strong></a>
                                                <?php
