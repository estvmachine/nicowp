...
?> 
    ...
    ================================================== */
    <?php
    $logo_font_family = ts_option_vs_default('logo_font_family', 'Montserrat');    
    $body_font_family = ts_option_vs_default('body_font_family', 'Open Sans');    
    $h1_font_family = ts_option_vs_default('h1_font_family', 'Montserrat');
    $h2_font_family = ts_option_vs_default('h2_font_family', 'Montserrat');
    $h3_font_family = ts_option_vs_default('h3_font_family', 'Montserrat');
    $h4_font_family = ts_option_vs_default('h4_font_family', 'Montserrat');
    $h5_font_family = ts_option_vs_default('h5_font_family', 'Open Sans');
    $h6_font_family = ts_option_vs_default('h6_font_family', 'Open Sans'); 
    $stylized_meta_font_family = ts_option_vs_default('stylized_meta_font_family', 'Libre Baskerville'); 
    $stylized_meta_font_style  = ts_option_vs_default('stylized_meta_font_style::style', 'italic');
    $form_font_family = ts_option_vs_default('form_font_family', 'Open Sans');
    $button_font_family = ts_option_vs_default('button_font_family', 'Open Sans');   
