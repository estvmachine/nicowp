...
.highlight { background-color: rgba(<?php echo ts_hex2rgb($ts_style_selector_default_primary_color);?>, .1); color: <?php echo esc_attr($ts_style_selector_default_primary_color);?>; }
